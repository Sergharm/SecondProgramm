...
// Типобезопасное перечисление пунктов меню с осмысленными именами
enum class MenuAction {
    PowerModulo      = 1,   // Задание 1: возведение в степень по модулю
    ExtendedEuclid   = 2,   // Задание 2: расширенный алгоритм Евклида
    ModularInverse   = 3,   // Задание 3: обратный элемент по модулю
    ElGamal          = 4,   // Задание 4: криптосистема Эль-Гамаля
    Diophantine      = 5,   // Задание 6*: диофантово уравнение
...
void showMenu() {
    while (true) {
        cout << "\n============================================\n";
        cout << "  Практическая работа №2 (Вариант 3)\n";
        cout << "============================================\n";
        ...
        switch (action) {
            ...
            case MenuAction::ExtendedEuclid: {
                ...
                // ИСПРАВЛЕНО: вычисляем в __int128, но выводим как int64_t
